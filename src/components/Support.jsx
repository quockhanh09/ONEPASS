        ...
        return (
          <div style={{ marginTop: 20 }}>
            <div style={{ fontFamily: "'Roboto', sans-serif", maxWidth: 900, margin: "60px auto", padding: 20, lineHeight: 1.8, color: "#111827", fontSize: 15, textAlign: "justify" }}>
              ...
              <p>{language === "VI" ? (<>02 Công ty có thể thay đổi các Điều khoản này khi có lý do hợp lý phát sinh, và khi thay đổi các điều khoản, Công ty sẽ công bố trước mà không chậm trễ. </>) :
              ...
              <h3 style={{ fontWeight: 700, fontSize: 18, marginTop: 40 }}>{language === "VI" ? (<>Điều 3 (Quy tắc bổ sung ngoài Điều khoản) </>) :
                ("제3조 (약관 외 준칙)")}</h3>
              <p>01{language === "VI" ? (<> Các Điều khoản này được áp dụng cùng với hướng dẫn sử dụng liên quan đến từng dịch vụ riêng biệt do Công ty cung cấp (sau đây gọi là Hướng dẫn theo dịch vụ). </>) :
                ("본 약관은 회사가 제공하는 개별 서비스와 관련된 이용 안내 (이하 서비스별 안내라 한다)와 함께 적용됩니다.")} </p>
              <p>02{language === "VI" ? (<> Đối với những vấn đề không được quy định trong Điều khoản này, có thể áp dụng theo pháp luật liên quan và mục đích của Hướng dẫn theo dịch vụ.</>) :
              ...
              <p>01 {language === "VI" ? (<>Công ty phải đảm bảo khách hàng sử dụng có thể sử dụng dịch vụ vào ngày bắt đầu cung cấp dịch vụ theo mong muốn, trừ khi có các trường hợp đặc biệt. </>) : ("회사는 특별한 사정이 없는 한 고객이 희망하는 서비스 개시일에 서비스를 이용할 수 있도록 보장해야 합니다.")} </p>
              <p>02 {language === "VI" ? (<>Để cung cấp dịch vụ liên tục và ổn định, khi có sự cố hoặc mất mát thiết bị, Công ty sẽ sửa chữa hoặc khôi phục ngay lập tức trừ khi có lý do bất khả kháng. </>) : (" 계속적이고 안정적인 서비스 제공을 위해 장비의 장애나 손실이 발생하면, 회사는 불가항력적인 사유가 없는 한 즉시 이를 수리하거나 복구합니다.")}</p>
              <p>03  {language === "VI" ? (<>Công ty xây dựng hệ thống bảo mật để bảo vệ thông tin cá nhân, công bố và tuân thủ Chính sách bảo vệ thông tin cá nhân. </>) : ("회사는 개인 정보 보호를 위한 보안 시스템을 구축하고, 개인정보 보호정책을 공시하고 준수합니다.")}</p>
              <p>04  {language === "VI" ? (<>Công ty xây dựng hệ thống bảo mật để bảo vệ thông tin cá nhân, công bố và tuân thủ Chính sách bảo vệ thông tin cá nhân. </>) : ("회사는 이용 고객의 의견이나 불만이 객관적으로 정당하다고 인정될 경우 적절한 절차를 거쳐 즉시 처리해야 합니다. 다만, 즉시 처리가 어려운 경우에는 고객에게 그 사유와 처리 일정을 통보해야 합니다.")}</p>

              <h3 style={{ fontWeight: 700, fontSize: 18, marginTop: 40 }}>{language === "VI" ? (<>Điều 6 (Nghĩa vụ của khách hàng)</>) : ("제6조 (고객의 의무)")}</h3>
              <p>01 {language === "VI" ? (<>Khách hàng phải điền tất cả các thông tin một cách trung thực bằng tên thật khi đăng ký khách hàng hoặc thay đổi thông tin khách hàng, và sẽ không thể yêu cầu bất kỳ quyền lợi nào nếu đăng ký thông tin sai sự thật hoặc thông tin của người khác.</>) :
                ("고객은 고객 등록 또는 고객 정보 변경 시 모든 정보를 실명으로 성실하게 기재해야 하며, 사실과 다르거나 타인의 정보를 등록한 경우 일체의 권리를 주장할 수 없습니다.")} </p>
              <p>02 {language === "VI" ? (<>Khách hàng phải tuân thủ các quy định trong Điều khoản này và các quy định chung khác do Công ty đặt ra, các thông báo do Công ty công bố, và pháp luật liên quan; không được thực hiện các hành vi gây cản trở công việc của Công ty hoặc làm tổn hại đến danh dự của Công ty. </>) :
                ("고객은 본 약관 및 회사가 정한 기타 일반 규정, 회사가 공시하는 공지사항, 관련 법령을 준수해야 하며, 회사의 업무를 방해하거나 회사의 명예를 훼손하는 행위를 해서는 안 됩니다.")}</p>
              <p>03 {language === "VI" ? (<>Khách hàng phải thông báo ngay cho Công ty khi có thay đổi trong các điều khoản hợp đồng sử dụng, như địa chỉ, thông tin liên hệ, địa chỉ email, bằng cách thực hiện các thủ tục liên quan. </>) :
                ("고객은 주소, 연락처, 이메일 주소 등 이용계약 사항이 변경된 경우 관련 절차를 거쳐 회사에 즉시 알려야 합니다.")}</p>
              <p>04 {language === "VI" ? (<>Khách hàng không được sử dụng dịch vụ để thực hiện hoạt động kinh doanh mà không có sự chấp thuận trước bằng văn bản của Công ty, và Công ty không chịu trách nhiệm về kết quả của hoạt động kinh doanh đó. Nếu Công ty bị thiệt hại do hoạt động kinh doanh đó, Khách hàng có nghĩa vụ bồi thường thiệt hại cho Công ty, và Công ty có thể hạn chế sử dụng dịch vụ và yêu cầu bồi thường thiệt hại đối với Khách hàng đó thông qua các thủ tục pháp lý thích hợp. </>) :
              ...
              <p>05 {language === "VI" ? (<>Khách hàng không được chuyển nhượng, tặng cho quyền sử dụng dịch vụ hoặc các vị trí khác trong hợp đồng sử dụng cho người khác, cũng như không được dùng chúng làm tài sản thế chấp mà không có sự đồng ý rõ ràng của Công ty. </>) :
                ("고객은 서비스 이용 권리 또는 이용계약상의 지위를 타인에게 양도, 증여할 수 없으며, 회사의 명시적인 동의 없이 이를 담보로 제공할 수 없습니다.")}</p>
              <p>06 {language === "VI" ? (<>Khách hàng không được xâm phạm quyền sở hữu trí tuệ của Công ty và bên thứ ba</>) :
                ("고객은 회사 및 제3자의 지적재산권을 침해해서는 안 됩니다.")}</p>
              <p>07 {language === "VI" ? (<>Khách hàng không được thực hiện các hành vi sau đây, và nếu thực hiện các hành vi đó, Công ty có thể áp dụng các biện pháp trừng phạt bao gồm hạn chế sử dụng dịch vụ và các biện pháp pháp lý thích hợp đối với Khách hàng:</>) :
              ...
              <h3 style={{ fontWeight: 700, fontSize: 18, marginTop: 40 }}>{language === "VI" ? (<>Điều 8 (Cung cấp Thông tin) </>) :
                ("제8조 (정보의 제공)")}</h3>
              <p>01 {language === "VI" ? (<>Công ty có thể cung cấp cho Khách hàng các thông tin khác nhau được coi là cần thiết cho việc sử dụng dịch vụ bằng phương pháp thư điện tử hoặc thư tín. </>) :
                ("회사는 고객에게 서비스 이용에 필요하다고 인정되는 다양한 정보를 전자우편이나 우편의 방법으로 제공할 수 있습니다.")}</p>
              <p>02 {language === "VI" ? (<>Công ty có thể yêu cầu thêm thông tin cá nhân dưới sự đồng ý của Khách hàng nhằm mục đích cải thiện dịch vụ và giới thiệu dịch vụ cho Khách hàng.</>) :
              ...
              <p>01 {language === "VI" ? (<>Một phần cơ sở đầu tư dịch vụ cho phép Công ty cung cấp dịch vụ cho Khách hàng đến từ lợi nhuận thông qua việc đăng tải quảng cáo. Khách hàng đồng ý với việc đăng tải quảng cáo được hiển thị khi sử dụng dịch vụ. </>) :
                ("회사가 고객에게 서비스를 제공할 수 있도록 하는 서비스 투자의 기반 중 일부는 광고 게재를 통한 수익에서 나옵니다. 고객은 서비스 이용 시 노출되는 광고 게재에 동의합니다.")}</p>
              <p>02 {language === "VI" ? (<>Công ty không chịu trách nhiệm về những tổn thất và thiệt hại phát sinh khi Khách hàng tham gia vào các hoạt động quảng bá, giao tiếp hoặc giao dịch với nhà quảng cáo được đăng trên dịch vụ hoặc thông qua dịch vụ này.</>) :
              ...
              <h3 style={{ fontWeight: 700, fontSize: 18, marginTop: 40 }}>{language === "VI" ? (<>Điều 10 (Hạn chế Sử dụng Dịch vụ) </>) :
                ("제10조 (서비스 이용 제한)")}</h3>
              <p>01 {language === "VI" ? (<>Công ty có thể hạn chế việc sử dụng dịch vụ nếu Khách hàng vi phạm nội dung Điều 11 của Điều khoản này trong việc sử dụng dịch vụ, hoặc thuộc một trong các trường hợp sau đây:</>) :
                ("회사가 고객에게 서비스를 제공할 수 있도록 하는 서비스 투자의 기반 중 일부는 광고 게재를 통한 수익에서 나옵니다. 고객은 서비스 이용 시 노출되는 광고 게재에 동의합니다.")}</p>
              <ul style={{ marginLeft: 20 }}>
              ...
              <h3 style={{ fontWeight: 700, fontSize: 18, marginTop: 40 }}>{language === "VI" ? (<>Điều 13 (Quyền Tài phán và Luật Áp dụng) </>) :
                ("제13조 (재판권 및 준거법)")}</h3>
              <p>01 {language === "VI" ? (<>Các vấn đề không được quy định rõ ràng trong Điều khoản này sẽ tuân theo pháp luật liên quan như Luật Doanh nghiệp Viễn thông và các tập quán thương mại. </>) :
                ("본 약관에 명시되지 않은 사항은 전기통신사업법 등 관련 법령 및 상관례에 따릅니다.")}</p>
              <p>02 {language === "VI" ? (<>Đối với Khách hàng sử dụng dịch vụ trả phí cố định và các dịch vụ trả phí khác của Công ty, sẽ tuân theo các điều khoản và chính sách riêng do Công ty đặt ra. </>) :
                ("회사의 정액제 유료 서비스 및 기타 유료 서비스를 이용하는 고객에 대해서는 회사가 별도로 정한 약관 및 정책에 따릅니다.")}</p>
              <p>03 {language === "VI" ? (<>Trong trường hợp có tranh chấp phát sinh do việc sử dụng dịch vụ và được đưa ra tòa án, tòa án có thẩm quyền sẽ là tòa án quản hạt nơi đặt trụ sở chính của Công ty.</>) :
