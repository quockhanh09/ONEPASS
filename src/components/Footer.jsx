        ...
        >
          ...
          <div style={{ flex: 1.4, minWidth: 500, display: "flex", flexDirection: "column", gap: 18, transform: "translateX(-60px)" }}>
            ...
            <div className="info-text" style={{ color: "#E8EEF9", fontSize: 16, fontWeight: 400, lineHeight: 1.9 }}>
              ...
              <div style={{marginBottom: 10}}>{language === "VI" ? (<> Seoul: Toà nhà Doosan We've Pavilion, Phòng 1238, 81,Sambong-ro Jongno-gu, Seoul, Hàn Quốc (03150) </>) : (<> 서울: (03150) 서울특별시 종로구 삼봉로 81 두산위브 파빌리온, 1238호) </>)}</div>
