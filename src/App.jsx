...
function App() {
  ...
  const serviceCardsData = {
    "번역, 공증 / 인증": [
      { img: a1, title: "번역 공증", desc: "베트남어, 한국어, 영어 등 각종 언어의 서류를 정확하고 신속하게 번역 및 공증" },
      { img: a1, title: "인증 센터", desc: "영사 확인, 사실인증" },

    ],
    "결혼 / 이혼": [
      { img: a2, title: "베트남에서 혼인 신고", desc: "한국에서의 결혼 등록 절차 전반을 대행하고 지원" },
      { img: a3, title: "한국에서 혼인 신고", desc: "혼인 관계 증명서 발급에 필요한 서류 컨설팅및 지원" },
      { img: a1, title: "혼인관계증명서 발급 신청", desc: "혼인 관계 증명서 발급에 필요한 서류 컨설팅및 지원" },
      { img: a4, title: "혼인요건인증서 발급 신청", desc: "결혼 이민 비자 신청에 필요한 서류 준비 및 절차 지원" },
      { img: a4, title: "혼인 재신고", desc: "결혼 이민 비자 신청에 필요한 서류 준비 및 절차 지원" },
      { img: a4, title: "결혼이민 비자신청", desc: "결혼 이민 비자 신청에 필요한 서류 준비 및 절차 지원" },

    ],
    "출생 / 사망 신고": [
      { img: a5, title: "출생 신고", desc: "신생아 출생 신고를 정확하고 신속하게 대행" },
      { img: a6, title: "기한 초과 출생신고", desc: "기간이 초과된 출생 신고 절차를 특별 지원" },
      { img: a7, title: "사망신고", desc: "사망 신고 및 관련 서류 처리 대행" },
      { img: a8, title: "기한 초과 사망신고", desc: "기간이 초과된 사망 신고 절차 지원 및 해결" },
    ],
    "출입국 / 국적 행정": [
      { img: a9, title: "베트남 국적 포기 신청", desc: "베트남 국적 포기 신청 및 서류 절차 대행" },
      { img: a10, title: "베트남 국적 유지 신청", desc: " 이중국적 유지를 위한 신고 및 관련 절차를지원" },
      { img: a11, title: "베트남 국적 귀화 신청", desc: "베트남 국적 귀화를 위한 신청 및 행정 절차 대행" },
      { img: a12, title: "베트남으로 시체, 유해, 유골 반입 허가 신청", desc: "기간이 초과된 사망 신고 절차 지원 및 해결" },
      { img: a13, title: "베트남 귀국절차 (베트남 상 주거주 신고)", desc: "재외 베트남인의 귀국 절차를 안내하고 대행" },
    ],
    "신분증명 서류": [
      { img: a14, title: "일반 여권 (재)발급·변경· 추가", desc: "일반 여권의 신규 발급, 정보 변경 및 추가 절차를 대행" },
      { img: a15, title: "호적 변경·정정·추가, 민족 재확인, 성별 재확인 등", desc: " 이름, 성별, 국적 등 호적 정보 변경 신청 및 관련 절차 지원" },
      { img: a16, title: "베트남 국민 신고 업데이트", desc: "재외 베트남인으로서의 국민 등록 및 정보 갱신 대행" },
      { img: a17, title: "베트남 출신 증명서 발급", desc: "베트남 출신 확인서 발급을 위한 서류 준비 및 절차 지원" },
      { img: a18, title: "호적증서 반사오 재발급", desc: "출생, 혼인 등 각종 호적 서류의 사본 재발급 대행" },
    ],
    "입양 절차 대행": [
      { img: a19, title: "보호자.인지해지 신고", desc: "재외 베트남인 간 또는 외국인과의 보호자 인지 등록, 해지 신고 대행" },
      { img: a20, title: "혼외자 자녀 인지", desc: "혼외자 자녀 인지 등록 절차 대행" },
      { img: a21, title: "입양 절차 대행", desc: "베트남 국적 아동의 입양 등록 및 재등록 절차를대행" },

    ],
    "비자 대행": [
      { img: a22, title: "베트남 통행증 발급", desc: "재외 공관에서 발급받은 통행증 발급 지원행" },
      { img: a23, title: "초청 (단기방문 C-3-1 비자)", desc: "한국 단기 방문 비자(C-3-1) 신청 및 발급 절차 지원" },
      { img: a24, title: "초청 (방문동거 F-1-5 비자)", desc: "한국 방문동거 비자(F-1-5) 신청에 필요한 서류 준비 및 절차 대행" },
      { img: a25, title: "베트남 비자면제증 발급", desc: " 베트남 비자 면제서의 신규 등록 및 재등록 절차 대행" },
      { img: a26, title: "베트남 전자비자 상용비자 발급", desc: "전자 비자(E-Visa) 및 상용 비자의 발급 등록 대행" },
    ],
    "법률 컨설팅": [
      { img: a27, title: "이혼 소송", desc: "베트남-한국 간 국제 이혼 소송의 제기 및 진행에 필요한 법적 절차 대행" },
      { img: a28, title: "노동 관련 소송", desc: "베트남/한국 노동법 관련 분쟁 발생 시 소송 제기 및 법률 자문" },
      { img: a29, title: "체류자 관련 컨설팅", desc: "베트남/한국 내 체류자의 자진 출국 및 합법적 체류 전환 등 민감한 문제 상담" },
    ],
    "B2B 서비스": [
      { img: a30, title: "베트남·한국에서 법인ㆍ지 사·대표 사무실 설립", desc: "한국 또는 베트남 내 법인, 지사, 또는 사무소 설립에 필요한 행정 절차 대행" },
      { img: a31, title: "베트남·한국 내 노동 허가 서, 임시 거주증 발급", desc: "한국/베트남 외국인 근로자의 취업 허가 및 임시 거주증 발급 절차 대행" },
      { img: a32, title: "수출입 허가서", desc: "기업의 원활한 무역 활동을 위한 수출입 허가증 발급 및 관련 규제 준수 절차 대행" },
      { img: a33, title: "B2B 바이어 매칭", desc: " B2B 파트너를 매칭하여 기업의 성공적인 시장 진출과 매출 확대" },
  ...
  const posts = [
    {
      img: news1,
      date: '2025년 10월 15일',
      title: '취류 비자·노동 관련 법률 변경 상세 안내',
      desc: '고객 여러분의 안정적인 체류와 노동 활동에 영향을 미치는 체류 비자 및 노동 관련 법률의 주요 변경...'
    },
    {
      img: news2,
      date: '2025년 10월 01일',
    ...
    },
    {
      ...
      desc: '안녕하세요, 고객 여러분! 베트남 통합 절차 대행 및 솔루션 전문 회사 원패스(One Pass)가 드디어...'
    }
  ];
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <label style={{ fontSize: 16 }}>이름</label>
                      <input
                        placeholder="이름"
                        value={name}
                  ...
                  <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <p style={{ fontSize: "18px", lineHeight: "1.7", color: "#333", marginBottom: "30px", }} >
                        2025년 부산에서 베트남인 및 한국인을 위한 최초 2025년 부산에서 베트남인 및 한국인을 위한 최초2025년 부산에서 베트남인 및 한국인을 위한 최초2025년 부산에서 베트남인 및 한국인을 위한 최초 2025년 부산에서 베트남인 및 한국인을 위한 최초 2025년 부산에서 베트남인 및 한국인을 위한 최초
                      </p>
                ...
                <section style={{ background: '#CFEAEC', padding: '80px 0' }}>
                  <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignSelf: 'center' }}>
                      <div style={{ color: '#2B3A67', fontWeight: 800, letterSpacing: '0.15em', marginBottom: 12, fontSize: 24 }}>CONSULT</div>
                      ...
                      <p style={{ marginTop: 20, color: '#234567', opacity: 0.85, fontSize: 16, lineHeight: 1.9, maxWidth: 520 }}>
                        2025년 부산에서 베트남인 및 한국인을 위한 최초2025년 부산에서 베트남인 및 한국인을 위한 최초2025년 부산에서 베트남인 및 한국인을 위한 최초2025년 부산에서 베트남인 및 한국인을
                      </p>
                    </div>
                    {/* Right cards */}
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
                      {[
                        { img: icPhone, title: '전화 상담', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor..' },
                        { img: icVisit, title: '방문 상담', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor..' },
                        { img: icChat, title: '채팅 상담', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor..' },
                        { img: icMail, title: '이메일 상담', desc: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor..' },
                      ].map((c, i) => {
